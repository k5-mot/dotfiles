...
" Highlight the symbol and its
" references when holding the cursor.
...
augroup mygroup
  ...
  " Update signature help on
  " jump placeholder.
  autocmd User CocJumpPlaceholder call CocActionAsync('showSignatureHelp')
augroup end

" Applying codeAction to the
" selected region.
" Example: `<leader>aap` for
" current paragraph
xmap <leader>a  <Plug>(coc-codeaction-selected)
nmap <leader>a  <Plug>(coc-codeaction-selected)

" Remap keys for applying
" codeAction to the current
" buffer.
nmap <leader>ac  <Plug>(coc-codeaction)
" Apply AutoFix to problem
" on the current line.
