...
## Linuxbrew troubleshooting
## Linuxbrew install gcc & glibc, in the case of CentOS6, CentOS7.
## Avoid ELF ERROR by conflicting between legacy glibc and new glibc.
## Create synbolic link in Linuxbrew directory from system gcc,g++.
## (Or local build gcc,g++).
