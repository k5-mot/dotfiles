...
LDFLAGS="-Wl,-rpath=$HOME/.anyenv/envs/pyenv/versions/2.7.18/lib:$HOME/.anyenv/envs/pyenv/versions/3.9.2/lib" ./configure \
--enable-cscope \
--enable-terminal \
--enable-fontset \
--enable-multibyte \
...
--enable-luainterp \
--with-features=huge \
--with-python3-command=$HOME/.anyenv/envs/pyenv/versions/3.9.2/bin/python3 \
