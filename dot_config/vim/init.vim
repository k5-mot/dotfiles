...
let g:vim_plugin_dir = expand('$VIM_CONFIG_HOME/plugins')
let g:viminfo        = expand('$VIM_CACHE_HOME/viminfo')
let g:backup_dir     = expand('$VIM_CACHE_HOME/backup')
let g:swap_dir       = expand('$VIM_CACHE_HOME/swap')
let g:undo_dir       = expand('$VIM_CACHE_HOME/undo')
let g:view_dir       = expand('$VIM_CACHE_HOME/view')
